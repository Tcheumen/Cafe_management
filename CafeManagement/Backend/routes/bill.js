...
router.post('/generateReport', auth.authenficateToken, (req, res) => {
...
router.post('/getPdf', auth.authenficateToken, (req, res) => {
    const orderDetails = req.body;
...
router.get('/getBills', auth.authenficateToken, (req, res, next) =>{
...
router.delete('/delete/:id', auth.authenficateToken, (req, res) => {
